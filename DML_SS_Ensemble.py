...
test2018_list = get_Test2018(isEightClass)
...
print(args.dataset)
F1,accuracy=utils.Ensemble_eval(args,models_,device,test2018_list,args.batch_size,centroids_)
if args.num_class==8:
...
utils.save_excel(accuracy,FileName) 